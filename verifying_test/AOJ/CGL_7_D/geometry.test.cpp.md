...
data:
  ...
  attributes:
    ...
    ERROR: 1e-6
    PROBLEM: http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_D&lang=ja
    links:
    - http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_D&lang=ja
  bundledCode: "#line 1 \"verifying_test/AOJ/CGL_7_D/geometry.test.cpp\"\n#define\
    \ PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_D&lang=ja\"\
    \n#define ERROR \"1e-6\"\n#define DESCRIPTION \"\u5186 $c$ \u3068\u76F4\u7DDA\
    ...
    \    Point ret(rx, ry); ret += a;\n    return ret;\n}\n#line 36 \"verifying_test/AOJ/CGL_7_D/geometry.test.cpp\"\
    ...
    \ ay}, ar);\n\n    int n; cin >> n;\n    for(int i=0; i<n; i++) {\n        double\
    \ px, py, qx, qy; cin >> px >> py >> qx >> qy;\n        Point x(px, py), y(qx,\
    \ qy);\n        vector<Point> ans = crossp_lc(x, y, a);\n        if(ans.size()\
    \ == 1) {\n            printf(\"%.10f %.10f %.10f %.10f\\n\", ans[0].real(), ans[0].imag(),\
    \ ans[0].real(), ans[0].imag());\n        }\n        else {\n            sort(ans.begin(),\
    \ ans.end());\n            printf(\"%.10f %.10f %.10f %.10f\\n\", ans[0].real(),\
    \ ans[0].imag(), ans[1].real(), ans[1].imag());\n        }\n    }\n    return\
    \ 0;\n}\n"
  code: "#define PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_D&lang=ja\"\
    \n#define ERROR \"1e-6\"\n#define DESCRIPTION \"\u5186 $c$ \u3068\u76F4\u7DDA\
    \ $l$ \u306E\u4EA4\u70B9\u3092\u6C42\u3081\u308B\"\n\n// #define _GLIBCXX_DEBUG\
    \ // for STL debug (optional)\n#include <iostream>\n#include <iomanip>\n#include\
    \ <cstdio>\n#include <string>\n#include <cstring>\n#include <deque>\n#include\
  ...
  verifiedWith: []
documentation_of: verifying_test/AOJ/CGL_7_D/geometry.test.cpp
layout: document
redirect_from:
- /verify/verifying_test/AOJ/CGL_7_D/geometry.test.cpp
- /verify/verifying_test/AOJ/CGL_7_D/geometry.test.cpp.html
