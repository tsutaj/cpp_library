...
data:
  ...
  attributes:
    ...
    PROBLEM: http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_1_C&lang=ja
    links:
    - http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_1_C&lang=ja
  bundledCode: "#line 1 \"verifying_test/AOJ/CGL_1_C/geometry.test.cpp\"\n#define\
    \ PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_1_C&lang=ja\"\
    \n#define DESCRIPTION \"$3$ \u70B9 $p_0, p_1, p_2$ \u306E\u4F4D\u7F6E\u95A2\u4FC2\
    ...
    \    Point ret(rx, ry); ret += a;\n    return ret;\n}\n#line 35 \"verifying_test/AOJ/CGL_1_C/geometry.test.cpp\"\
    ...
    \ cy);\n        int ans = ccw(a, b, c);\n        cout << m[ans] << endl;\n   \
    \ }\n    return 0;\n}\n"
  code: "#define PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_1_C&lang=ja\"\
    \n#define DESCRIPTION \"$3$ \u70B9 $p_0, p_1, p_2$ \u306E\u4F4D\u7F6E\u95A2\u4FC2\
    \ (ccw) \u3092\u6C42\u3081\u308B\"\n\n// #define _GLIBCXX_DEBUG // for STL debug\
    \ (optional)\n#include <iostream>\n#include <iomanip>\n#include <cstdio>\n#include\
    \ <string>\n#include <cstring>\n#include <deque>\n#include <list>\n#include <queue>\n\
  ...
  verifiedWith: []
documentation_of: verifying_test/AOJ/CGL_1_C/geometry.test.cpp
layout: document
redirect_from:
- /verify/verifying_test/AOJ/CGL_1_C/geometry.test.cpp
- /verify/verifying_test/AOJ/CGL_1_C/geometry.test.cpp.html
