...
data:
  ...
  bundledCode: "#line 1 \"verifying_test/AOJ/interval_heap/0001_init.test.cpp\"\n\
    ...
    \ 1], data_[i]);\n            }\n            size_t k = down(i);\n           \
    \ up(k, i);\n        }\n    }\n};\n#line 8 \"verifying_test/AOJ/interval_heap/0001_init.test.cpp\"\
    \n\nint main() {\n    vector<int> data;\n    for(int i=0; i<10; i++) {\n     \
  ...
  verifiedWith: []
documentation_of: verifying_test/AOJ/interval_heap/0001_init.test.cpp
layout: document
redirect_from:
- /verify/verifying_test/AOJ/interval_heap/0001_init.test.cpp
- /verify/verifying_test/AOJ/interval_heap/0001_init.test.cpp.html
