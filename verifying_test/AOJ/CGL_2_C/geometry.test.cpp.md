...
data:
  ...
  attributes:
    ...
    ERROR: 1e-8
    PROBLEM: http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_2_C&lang=ja
    links:
    - http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_2_C&lang=ja
  bundledCode: "#line 1 \"verifying_test/AOJ/CGL_2_C/geometry.test.cpp\"\n#define\
    \ PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_2_C&lang=ja\"\
    \n#define ERROR \"1e-8\"\n#define DESCRIPTION \"\u7DDA\u5206 $s_1, s_2$ \u306E\
    ...
    \    Point ret(rx, ry); ret += a;\n    return ret;\n}\n#line 36 \"verifying_test/AOJ/CGL_2_C/geometry.test.cpp\"\
    ...
    \        printf(\"%.10f %.10f\\n\", ans.real(), ans.imag());\n    }\n    return\
    \ 0;\n}\n"
  code: "#define PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_2_C&lang=ja\"\
    \n#define ERROR \"1e-8\"\n#define DESCRIPTION \"\u7DDA\u5206 $s_1, s_2$ \u306E\
    \u4EA4\u70B9\u306E\u5EA7\u6A19\u3092\u6C42\u3081\u308B\"\n\n// #define _GLIBCXX_DEBUG\
    \ // for STL debug (optional)\n#include <iostream>\n#include <iomanip>\n#include\
    \ <cstdio>\n#include <string>\n#include <cstring>\n#include <deque>\n#include\
  ...
  verifiedWith: []
documentation_of: verifying_test/AOJ/CGL_2_C/geometry.test.cpp
layout: document
redirect_from:
- /verify/verifying_test/AOJ/CGL_2_C/geometry.test.cpp
- /verify/verifying_test/AOJ/CGL_2_C/geometry.test.cpp.html
