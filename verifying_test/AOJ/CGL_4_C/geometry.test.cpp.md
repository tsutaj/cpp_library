...
data:
  ...
  attributes:
    ...
    ERROR: 1e-5
    PROBLEM: http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_4_C&lang=ja
    links:
    - http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_4_C&lang=ja
  bundledCode: "#line 1 \"verifying_test/AOJ/CGL_4_C/geometry.test.cpp\"\n#define\
    \ PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_4_C&lang=ja\"\
    \n#define ERROR \"1e-5\"\n#define DESCRIPTION \"\u51F8\u591A\u89D2\u5F62 $g$ \u3092\
    \u76F4\u7DDA $p_1 p_2$ \u3067\u5207\u65AD\u3057\u305F\u3068\u304D\u306E\u3001\u305D\
    \u306E\u5DE6\u5074\u306B\u3067\u304D\u308B\u51F8\u591A\u89D2\u5F62\u306E\u9762\
    ...
    \      printf(\"%.10f\\n\", area(ret));\n    }\n    return 0;\n}\n"
  code: "#define PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_4_C&lang=ja\"\
    \n#define ERROR \"1e-5\"\n#define DESCRIPTION \"\u51F8\u591A\u89D2\u5F62 $g$ \u3092\
    \u76F4\u7DDA $p_1 p_2$ \u3067\u5207\u65AD\u3057\u305F\u3068\u304D\u306E\u3001\u305D\
    \u306E\u5DE6\u5074\u306B\u3067\u304D\u308B\u51F8\u591A\u89D2\u5F62\u306E\u9762\
    \u7A4D (Convex Cut) \u3092\u6C42\u3081\u308B\"\n\n// #define _GLIBCXX_DEBUG //\
  ...
  verifiedWith: []
documentation_of: verifying_test/AOJ/CGL_4_C/geometry.test.cpp
layout: document
redirect_from:
- /verify/verifying_test/AOJ/CGL_4_C/geometry.test.cpp
- /verify/verifying_test/AOJ/CGL_4_C/geometry.test.cpp.html
