...
data:
  ...
  attributes:
    ...
    ERROR: 1e-6
    PROBLEM: http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_E&lang=ja
    links:
    - http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_E&lang=ja
  bundledCode: "#line 1 \"verifying_test/AOJ/CGL_7_E/geometry.test.cpp\"\n#define\
    \ PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_E&lang=ja\"\
    ...
    \    Point ret(rx, ry); ret += a;\n    return ret;\n}\n#line 36 \"verifying_test/AOJ/CGL_7_E/geometry.test.cpp\"\
    ...
    \    }\n    return 0;\n}\n"
  code: "#define PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_E&lang=ja\"\
    \n#define ERROR \"1e-6\"\n#define DESCRIPTION \"$2$ \u3064\u306E\u5186 $c_1, c_2$\
    \ \u306E\u4EA4\u70B9\u3092\u6C42\u3081\u308B\"\n\n// #define _GLIBCXX_DEBUG //\
    \ for STL debug (optional)\n#include <iostream>\n#include <iomanip>\n#include\
    \ <cstdio>\n#include <string>\n#include <cstring>\n#include <deque>\n#include\
  ...
  verifiedWith: []
documentation_of: verifying_test/AOJ/CGL_7_E/geometry.test.cpp
layout: document
redirect_from:
- /verify/verifying_test/AOJ/CGL_7_E/geometry.test.cpp
- /verify/verifying_test/AOJ/CGL_7_E/geometry.test.cpp.html
