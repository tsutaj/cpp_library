...
data:
  ...
  attributes:
    ...
    PROBLEM: http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_2_B&lang=ja
    links:
    - http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_2_B&lang=ja
  bundledCode: "#line 1 \"verifying_test/AOJ/CGL_2_B/geometry.test.cpp\"\n#define\
    \ PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_2_B&lang=ja\"\
    \n#define DESCRIPTION \"\u7DDA\u5206 $s_1, s_2$ \u306B\u3064\u3044\u3066\u3001\
    ...
    \ a(ax, ay), b(bx, by), c(cx, cy), d(dx, dy); \n        if(isec_ss(a,b,c,d)) cout\
    \ << 1 << endl;\n        else cout << 0 << endl;\n    }\n    return 0;\n}\n"
  code: "#define PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_2_B&lang=ja\"\
    \n#define DESCRIPTION \"\u7DDA\u5206 $s_1, s_2$ \u306B\u3064\u3044\u3066\u3001\
    \u4EA4\u5DEE\u3092\u5224\u5B9A\"\n\n// #define _GLIBCXX_DEBUG // for STL debug\
    \ (optional)\n#include <iostream>\n#include <iomanip>\n#include <cstdio>\n#include\
    \ <string>\n#include <cstring>\n#include <deque>\n#include <list>\n#include <queue>\n\
  ...
  verifiedWith: []
documentation_of: verifying_test/AOJ/CGL_2_B/geometry.test.cpp
layout: document
redirect_from:
- /verify/verifying_test/AOJ/CGL_2_B/geometry.test.cpp
- /verify/verifying_test/AOJ/CGL_2_B/geometry.test.cpp.html
