...
data:
  ...
  attributes:
    ...
    ERROR: 1e-5
    PROBLEM: http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_G&lang=ja
    links:
    - http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_G&lang=ja
  bundledCode: "#line 1 \"verifying_test/AOJ/CGL_7_G/geometry.test.cpp\"\n#define\
    \ PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_G&lang=ja\"\
    \n#define ERROR \"1e-5\"\n#define DESCRIPTION \"$2$ \u3064\u306E\u5186 $c_1, c_2$\
    ...
    \    Point ret(rx, ry); ret += a;\n    return ret;\n}\n#line 36 \"verifying_test/AOJ/CGL_7_G/geometry.test.cpp\"\
    ...
    \ ans = tangentLines(a, b);\n    sort(ans.begin(), ans.end());\n    for(size_t\
    \ i=0; i<ans.size(); i++) {\n        /*\n        if(abs(ans[i].first.real()) <\
    \ EPS) ans[i].first.real() = 0.0;\n        if(abs(ans[i].first.imag()) < EPS)\
    \ ans[i].first.imag() = 0.0;\n        */\n        printf(\"%.10f %.10f\\n\", ans[i].first.real(),\
    \ ans[i].first.imag());\n    }\n    return 0;\n}\n"
  code: "#define PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_G&lang=ja\"\
    \n#define ERROR \"1e-5\"\n#define DESCRIPTION \"$2$ \u3064\u306E\u5186 $c_1, c_2$\
    \ \u306E\u5171\u901A\u63A5\u7DDA\u3092\u6C42\u3081\u308B\"\n\n// #define _GLIBCXX_DEBUG\
    \ // for STL debug (optional)\n#include <iostream>\n#include <iomanip>\n#include\
    \ <cstdio>\n#include <string>\n#include <cstring>\n#include <deque>\n#include\
  ...
  verifiedWith: []
documentation_of: verifying_test/AOJ/CGL_7_G/geometry.test.cpp
layout: document
redirect_from:
- /verify/verifying_test/AOJ/CGL_7_G/geometry.test.cpp
- /verify/verifying_test/AOJ/CGL_7_G/geometry.test.cpp.html
