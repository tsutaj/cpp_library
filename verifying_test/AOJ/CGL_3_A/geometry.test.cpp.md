...
data:
  ...
  attributes:
    ...
    PROBLEM: http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_3_A&lang=ja
    links:
    - http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_3_A&lang=ja
  bundledCode: "#line 1 \"verifying_test/AOJ/CGL_3_A/geometry.test.cpp\"\n#define\
    \ PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_3_A&lang=ja\"\
    \n#define DESCRIPTION \"\u51F8\u3068\u306F\u9650\u3089\u306A\u3044\u591A\u89D2\
    ...
    \    Point ret(rx, ry); ret += a;\n    return ret;\n}\n#line 35 \"verifying_test/AOJ/CGL_3_A/geometry.test.cpp\"\
    ...
    \ y);\n    }\n    printf(\"%.1f\\n\", area(array));\n    return 0;\n}\n"
  code: "#define PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_3_A&lang=ja\"\
    \n#define DESCRIPTION \"\u51F8\u3068\u306F\u9650\u3089\u306A\u3044\u591A\u89D2\
    \u5F62\u306E\u9762\u7A4D\u3092\u8A08\u7B97\u3059\u308B\"\n\n// #define _GLIBCXX_DEBUG\
    \ // for STL debug (optional)\n#include <iostream>\n#include <iomanip>\n#include\
    \ <cstdio>\n#include <string>\n#include <cstring>\n#include <deque>\n#include\
  ...
  requiredBy: []
  timestamp: '2019-11-24 18:06:16+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: verifying_test/AOJ/CGL_3_A/geometry.test.cpp
layout: document
redirect_from:
- /verify/verifying_test/AOJ/CGL_3_A/geometry.test.cpp
- /verify/verifying_test/AOJ/CGL_3_A/geometry.test.cpp.html
