...
data:
  ...
  attributes:
    ...
    PROBLEM: http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_4_A&lang=ja
    links:
    - http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_4_A&lang=ja
  bundledCode: "#line 1 \"verifying_test/AOJ/CGL_4_A/geometry.test.cpp\"\n#define\
    \ PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_4_A&lang=ja\"\
    \n#define DESCRIPTION \"\u4E8C\u6B21\u5143\u5E73\u9762\u306B\u304A\u3051\u308B\
    \u70B9\u96C6\u5408 $P$ \u306E\u51F8\u5305\u3092\u6C42\u3081\u308B\"\n\n// #define\
    ...
    \    Point ret(rx, ry); ret += a;\n    return ret;\n}\n#line 35 \"verifying_test/AOJ/CGL_4_A/geometry.test.cpp\"\
    ...
    n\", (int)ans[i].real(), (int)ans[i].imag());\n    }\n    return 0;\n}\n"
  code: "#define PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_4_A&lang=ja\"\
    \n#define DESCRIPTION \"\u4E8C\u6B21\u5143\u5E73\u9762\u306B\u304A\u3051\u308B\
    \u70B9\u96C6\u5408 $P$ \u306E\u51F8\u5305\u3092\u6C42\u3081\u308B\"\n\n// #define\
    \ _GLIBCXX_DEBUG // for STL debug (optional)\n#include <iostream>\n#include <iomanip>\n\
    #include <cstdio>\n#include <string>\n#include <cstring>\n#include <deque>\n#include\
  ...
  verifiedWith: []
documentation_of: verifying_test/AOJ/CGL_4_A/geometry.test.cpp
layout: document
redirect_from:
- /verify/verifying_test/AOJ/CGL_4_A/geometry.test.cpp
- /verify/verifying_test/AOJ/CGL_4_A/geometry.test.cpp.html
