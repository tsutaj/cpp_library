...
data:
  ...
  attributes:
    ...
    ERROR: 1e-5
    PROBLEM: http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_F&lang=ja
    links:
    - http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_F&lang=ja
  bundledCode: "#line 1 \"verifying_test/AOJ/CGL_7_F/geometry.test.cpp\"\n#define\
    \ PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_F&lang=ja\"\
    \n#define ERROR \"1e-5\"\n#define DESCRIPTION \"\u70B9 $p$ \u3092\u901A\u308B\u5186\
    ...
    \    Point ret(rx, ry); ret += a;\n    return ret;\n}\n#line 36 \"verifying_test/AOJ/CGL_7_F/geometry.test.cpp\"\
    ...
    \    printf(\"%.10f %.10f\\n%.10f %.10f\\n\", ans[0].real(), ans[0].imag(), ans[1].real(),\
    \ ans[1].imag());\n    return 0;\n}\n"
  code: "#define PROBLEM \"http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_F&lang=ja\"\
    \n#define ERROR \"1e-5\"\n#define DESCRIPTION \"\u70B9 $p$ \u3092\u901A\u308B\u5186\
    \ $c$ \u306E\u63A5\u7DDA\u3092\u6C42\u3081\u308B\"\n\n// #define _GLIBCXX_DEBUG\
    \ // for STL debug (optional)\n#include <iostream>\n#include <iomanip>\n#include\
    \ <cstdio>\n#include <string>\n#include <cstring>\n#include <deque>\n#include\
  ...
  verifiedWith: []
documentation_of: verifying_test/AOJ/CGL_7_F/geometry.test.cpp
layout: document
redirect_from:
- /verify/verifying_test/AOJ/CGL_7_F/geometry.test.cpp
- /verify/verifying_test/AOJ/CGL_7_F/geometry.test.cpp.html
