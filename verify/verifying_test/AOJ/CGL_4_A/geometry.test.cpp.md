...
# :heavy_check_mark: 二次元平面における点集合 $P$ の凸包を求める <small>(verifying_test/AOJ/CGL_4_A/geometry.test.cpp)</small>
...
{% raw %}
```cpp
#line 1 "verifying_test/AOJ/CGL_4_A/geometry.test.cpp"
#define PROBLEM "http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_4_A&lang=ja"
#define DESCRIPTION "二次元平面における点集合 $P$ の凸包を求める"
...
#line 1 "verifying_test/AOJ/CGL_4_A/../../../geometry/geometry_2D.cpp"
/***** 基本的準備 *****/
