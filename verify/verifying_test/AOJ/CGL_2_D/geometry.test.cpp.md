...
# :heavy_check_mark: 線分 $s_1, s_2$ についてそれらの距離を求める <small>(verifying_test/AOJ/CGL_2_D/geometry.test.cpp)</small>
...
{% raw %}
```cpp
#line 1 "verifying_test/AOJ/CGL_2_D/geometry.test.cpp"
#define PROBLEM "http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_2_D&lang=ja"
#define ERROR "1e-8"
#define DESCRIPTION "線分 $s_1, s_2$ についてそれらの距離を求める"
...
#line 1 "verifying_test/AOJ/CGL_2_D/../../../geometry/geometry_2D.cpp"
/***** 基本的準備 *****/
