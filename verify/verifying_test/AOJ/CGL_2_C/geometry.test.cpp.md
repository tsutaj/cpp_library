...
# :heavy_check_mark: 線分 $s_1, s_2$ の交点の座標を求める <small>(verifying_test/AOJ/CGL_2_C/geometry.test.cpp)</small>
...
{% raw %}
```cpp
#line 1 "verifying_test/AOJ/CGL_2_C/geometry.test.cpp"
#define PROBLEM "http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_2_C&lang=ja"
#define ERROR "1e-8"
#define DESCRIPTION "線分 $s_1, s_2$ の交点の座標を求める"
...
#line 1 "verifying_test/AOJ/CGL_2_C/../../../geometry/geometry_2D.cpp"
/***** 基本的準備 *****/
