...
# :heavy_check_mark: 多角形 $g$ と点 $p$ について、$p$ が $g$ に含まれるか・辺上にあるかを判定 <small>(verifying_test/AOJ/CGL_3_C/geometry.test.cpp)</small>
...
{% raw %}
```cpp
#line 1 "verifying_test/AOJ/CGL_3_C/geometry.test.cpp"
#define PROBLEM "http://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_3_C&lang=ja"
#define DESCRIPTION "多角形 $g$ と点 $p$ について、$p$ が $g$ に含まれるか・辺上にあるかを判定"
...
#line 1 "verifying_test/AOJ/CGL_3_C/../../../geometry/geometry_2D.cpp"
/***** 基本的準備 *****/
